...
TimestampDurationTestCases::TimestampDurationTestCases(const TimestampDurationTestCases& from)
  ...
  if (from._internal_has_epoch()) {
    _impl_.epoch_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.epoch_);
  }
  if (from._internal_has_epoch2()) {
    _impl_.epoch2_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.epoch2_);
  }
  if (from._internal_has_mintime()) {
    _impl_.mintime_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.mintime_);
  }
  if (from._internal_has_maxtime()) {
    _impl_.maxtime_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.maxtime_);
  }
  if (from._internal_has_timeval1()) {
    _impl_.timeval1_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval1_);
  }
  if (from._internal_has_timeval2()) {
    _impl_.timeval2_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval2_);
  }
  if (from._internal_has_timeval3()) {
    _impl_.timeval3_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval3_);
  }
  if (from._internal_has_timeval4()) {
    _impl_.timeval4_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval4_);
  }
  if (from._internal_has_timeval5()) {
    _impl_.timeval5_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval5_);
  }
  if (from._internal_has_timeval6()) {
    _impl_.timeval6_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval6_);
  }
  if (from._internal_has_timeval7()) {
    _impl_.timeval7_ = new ::proto_util_converter::testing::TimeStampType(*from._impl_.timeval7_);
  }
  if (from._internal_has_timeval8()) {
    _impl_.timeval8_ = new ::PROTOBUF_NAMESPACE_ID::Timestamp(*from._impl_.timeval8_);
  }
  if (from._internal_has_zero_duration()) {
    _impl_.zero_duration_ = new ::proto_util_converter::testing::DurationType(*from._impl_.zero_duration_);
  }
  if (from._internal_has_min_duration()) {
    _impl_.min_duration_ = new ::proto_util_converter::testing::DurationType(*from._impl_.min_duration_);
  }
  if (from._internal_has_max_duration()) {
    _impl_.max_duration_ = new ::proto_util_converter::testing::DurationType(*from._impl_.max_duration_);
  }
  if (from._internal_has_duration1()) {
    _impl_.duration1_ = new ::proto_util_converter::testing::DurationType(*from._impl_.duration1_);
  }
  if (from._internal_has_duration2()) {
    _impl_.duration2_ = new ::proto_util_converter::testing::DurationType(*from._impl_.duration2_);
  }
  if (from._internal_has_duration3()) {
    _impl_.duration3_ = new ::proto_util_converter::testing::DurationType(*from._impl_.duration3_);
  }
  if (from._internal_has_duration4()) {
    _impl_.duration4_ = new ::proto_util_converter::testing::DurationType(*from._impl_.duration4_);
  }
  if (from._internal_has_duration5()) {
    _impl_.duration5_ = new ::PROTOBUF_NAMESPACE_ID::Duration(*from._impl_.duration5_);
  }
...
TimestampDuration::TimestampDuration(const TimestampDuration& from)
  ...
  if (from._internal_has_ts()) {
    _impl_.ts_ = new ::PROTOBUF_NAMESPACE_ID::Timestamp(*from._impl_.ts_);
  }
  if (from._internal_has_dur()) {
    _impl_.dur_ = new ::PROTOBUF_NAMESPACE_ID::Duration(*from._impl_.dur_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.TimestampDuration)
  ...
  _impl_.rep_ts_.MergeFrom(from._impl_.rep_ts_);
  if (from._internal_has_ts()) {
