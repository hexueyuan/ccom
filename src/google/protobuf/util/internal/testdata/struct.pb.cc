...
StructTestCases::StructTestCases(const StructTestCases& from)
  ...
  if (from._internal_has_empty_value()) {
    _impl_.empty_value_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.empty_value_);
  }
  if (from._internal_has_empty_value2()) {
    _impl_.empty_value2_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.empty_value2_);
  }
  if (from._internal_has_null_value()) {
    _impl_.null_value_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.null_value_);
  }
  if (from._internal_has_simple_struct()) {
    _impl_.simple_struct_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.simple_struct_);
  }
  if (from._internal_has_longer_struct()) {
    _impl_.longer_struct_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.longer_struct_);
  }
  if (from._internal_has_struct_with_nested_struct()) {
    _impl_.struct_with_nested_struct_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_nested_struct_);
  }
  if (from._internal_has_struct_with_nested_list()) {
    _impl_.struct_with_nested_list_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_nested_list_);
  }
  if (from._internal_has_struct_with_list_of_nulls()) {
    _impl_.struct_with_list_of_nulls_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_list_of_nulls_);
  }
  if (from._internal_has_struct_with_list_of_lists()) {
    _impl_.struct_with_list_of_lists_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_list_of_lists_);
  }
  if (from._internal_has_struct_with_list_of_structs()) {
    _impl_.struct_with_list_of_structs_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_list_of_structs_);
  }
  if (from._internal_has_struct_with_empty_list()) {
    _impl_.struct_with_empty_list_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_empty_list_);
  }
  if (from._internal_has_struct_with_list_with_empty_struct()) {
    _impl_.struct_with_list_with_empty_struct_ = new ::proto_util_converter::testing::StructWrapper(*from._impl_.struct_with_list_with_empty_struct_);
  }
  ...
  if (from._internal_has_top_level_struct_with_empty_list()) {
    _impl_.top_level_struct_with_empty_list_ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.top_level_struct_with_empty_list_);
  }
  if (from._internal_has_top_level_struct_with_list_with_empty_struct()) {
    _impl_.top_level_struct_with_list_with_empty_struct_ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.top_level_struct_with_list_with_empty_struct_);
  }
  if (from._internal_has_value_wrapper_simple()) {
    _impl_.value_wrapper_simple_ = new ::proto_util_converter::testing::ValueWrapper(*from._impl_.value_wrapper_simple_);
  }
  if (from._internal_has_value_wrapper_with_struct()) {
    _impl_.value_wrapper_with_struct_ = new ::proto_util_converter::testing::ValueWrapper(*from._impl_.value_wrapper_with_struct_);
  }
  if (from._internal_has_value_wrapper_with_list()) {
    _impl_.value_wrapper_with_list_ = new ::proto_util_converter::testing::ValueWrapper(*from._impl_.value_wrapper_with_list_);
  }
  if (from._internal_has_value_wrapper_with_empty_list()) {
    _impl_.value_wrapper_with_empty_list_ = new ::proto_util_converter::testing::ValueWrapper(*from._impl_.value_wrapper_with_empty_list_);
  }
  if (from._internal_has_value_wrapper_with_list_with_empty_struct()) {
    _impl_.value_wrapper_with_list_with_empty_struct_ = new ::proto_util_converter::testing::ValueWrapper(*from._impl_.value_wrapper_with_list_with_empty_struct_);
  }
  if (from._internal_has_list_value_wrapper()) {
    _impl_.list_value_wrapper_ = new ::proto_util_converter::testing::ListValueWrapper(*from._impl_.list_value_wrapper_);
  }
  if (from._internal_has_list_value_wrapper_with_empty_list()) {
    _impl_.list_value_wrapper_with_empty_list_ = new ::proto_util_converter::testing::ListValueWrapper(*from._impl_.list_value_wrapper_with_empty_list_);
  }
  if (from._internal_has_list_value_wrapper_with_list_with_empty_struct()) {
    _impl_.list_value_wrapper_with_list_with_empty_struct_ = new ::proto_util_converter::testing::ListValueWrapper(*from._impl_.list_value_wrapper_with_list_with_empty_struct_);
  }
  ...
  if (from._internal_has_top_level_value_with_empty_list()) {
    _impl_.top_level_value_with_empty_list_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.top_level_value_with_empty_list_);
  }
  if (from._internal_has_top_level_value_with_list_with_empty_struct()) {
    _impl_.top_level_value_with_list_with_empty_struct_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.top_level_value_with_list_with_empty_struct_);
  }
  ...
  if (from._internal_has_top_level_empty_listvalue()) {
    _impl_.top_level_empty_listvalue_ = new ::PROTOBUF_NAMESPACE_ID::ListValue(*from._impl_.top_level_empty_listvalue_);
  }
  if (from._internal_has_top_level_listvalue_with_empty_struct()) {
    _impl_.top_level_listvalue_with_empty_struct_ = new ::PROTOBUF_NAMESPACE_ID::ListValue(*from._impl_.top_level_listvalue_with_empty_struct_);
  }
  if (from._internal_has_repeated_value()) {
    _impl_.repeated_value_ = new ::proto_util_converter::testing::RepeatedValueWrapper(*from._impl_.repeated_value_);
  }
  if (from._internal_has_repeated_value_nested_list()) {
    _impl_.repeated_value_nested_list_ = new ::proto_util_converter::testing::RepeatedValueWrapper(*from._impl_.repeated_value_nested_list_);
  }
  if (from._internal_has_repeated_value_nested_list2()) {
    _impl_.repeated_value_nested_list2_ = new ::proto_util_converter::testing::RepeatedValueWrapper(*from._impl_.repeated_value_nested_list2_);
  }
  if (from._internal_has_repeated_value_nested_list3()) {
    _impl_.repeated_value_nested_list3_ = new ::proto_util_converter::testing::RepeatedValueWrapper(*from._impl_.repeated_value_nested_list3_);
  }
  if (from._internal_has_repeated_listvalue()) {
    _impl_.repeated_listvalue_ = new ::proto_util_converter::testing::RepeatedListValueWrapper(*from._impl_.repeated_listvalue_);
  }
  if (from._internal_has_map_of_struct()) {
    _impl_.map_of_struct_ = new ::proto_util_converter::testing::MapOfStruct(*from._impl_.map_of_struct_);
  }
  if (from._internal_has_map_of_struct_value()) {
    _impl_.map_of_struct_value_ = new ::proto_util_converter::testing::MapOfStruct(*from._impl_.map_of_struct_value_);
  }
  if (from._internal_has_map_of_listvalue()) {
    _impl_.map_of_listvalue_ = new ::proto_util_converter::testing::MapOfStruct(*from._impl_.map_of_listvalue_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.RepeatedListValueWrapper)
  ...
  _impl_.dimensions_.MergeFrom(from._impl_.dimensions_);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
MapOfStruct::MapOfStruct(const MapOfStruct& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.struct_map_.MergeFrom(from._impl_.struct_map_);
  _impl_.value_map_.MergeFrom(from._impl_.value_map_);
  _impl_.listvalue_map_.MergeFrom(from._impl_.listvalue_map_);
...
StructType::StructType(const StructType& from)
  ...
  if (from._internal_has_object()) {
    _impl_.object_ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.object_);
  }
