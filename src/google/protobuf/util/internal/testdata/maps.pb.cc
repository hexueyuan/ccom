...
MapsTestCases::MapsTestCases(const MapsTestCases& from)
  ...
  if (from._internal_has_empty_map()) {
    _impl_.empty_map_ = new ::proto_util_converter::testing::EmptyMap(*from._impl_.empty_map_);
  }
  if (from._internal_has_string_to_int()) {
    _impl_.string_to_int_ = new ::proto_util_converter::testing::StringtoInt(*from._impl_.string_to_int_);
  }
  if (from._internal_has_int_to_string()) {
    _impl_.int_to_string_ = new ::proto_util_converter::testing::IntToString(*from._impl_.int_to_string_);
  }
  if (from._internal_has_mixed1()) {
    _impl_.mixed1_ = new ::proto_util_converter::testing::Mixed1(*from._impl_.mixed1_);
  }
  if (from._internal_has_mixed2()) {
    _impl_.mixed2_ = new ::proto_util_converter::testing::Mixed2(*from._impl_.mixed2_);
  }
  if (from._internal_has_map_of_objects()) {
    _impl_.map_of_objects_ = new ::proto_util_converter::testing::MapOfObjects(*from._impl_.map_of_objects_);
  }
  if (from._internal_has_empty_key_string_to_int1()) {
    _impl_.empty_key_string_to_int1_ = new ::proto_util_converter::testing::StringtoInt(*from._impl_.empty_key_string_to_int1_);
  }
  if (from._internal_has_empty_key_string_to_int2()) {
    _impl_.empty_key_string_to_int2_ = new ::proto_util_converter::testing::StringtoInt(*from._impl_.empty_key_string_to_int2_);
  }
  if (from._internal_has_empty_key_string_to_int3()) {
    _impl_.empty_key_string_to_int3_ = new ::proto_util_converter::testing::StringtoInt(*from._impl_.empty_key_string_to_int3_);
  }
  if (from._internal_has_empty_key_bool_to_string()) {
    _impl_.empty_key_bool_to_string_ = new ::proto_util_converter::testing::BoolToString(*from._impl_.empty_key_bool_to_string_);
  }
  if (from._internal_has_empty_key_int_to_string()) {
    _impl_.empty_key_int_to_string_ = new ::proto_util_converter::testing::IntToString(*from._impl_.empty_key_int_to_string_);
  }
  if (from._internal_has_empty_key_mixed()) {
    _impl_.empty_key_mixed_ = new ::proto_util_converter::testing::Mixed1(*from._impl_.empty_key_mixed_);
  }
  if (from._internal_has_empty_key_map_objects()) {
    _impl_.empty_key_map_objects_ = new ::proto_util_converter::testing::MapOfObjects(*from._impl_.empty_key_map_objects_);
  }
...
MapIn::MapIn(const MapIn& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.map_input_.MergeFrom(from._impl_.map_input_);
  _impl_.map_any_.MergeFrom(from._impl_.map_any_);
  _impl_.other_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.other_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_other().empty()) {
    _impl_.other_.Set(from._internal_other(), 
      GetArenaForAllocation());
  }
...
MapOut::MapOut(const MapOut& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.map1_.MergeFrom(from._impl_.map1_);
  _impl_.map2_.MergeFrom(from._impl_.map2_);
  _impl_.map3_.MergeFrom(from._impl_.map3_);
  _impl_.map4_.MergeFrom(from._impl_.map4_);
  _impl_.bar_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.bar_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_bar().empty()) {
    _impl_.bar_.Set(from._internal_bar(), 
      GetArenaForAllocation());
  }
...
MapOutWireFormat_Map1Entry::MapOutWireFormat_Map1Entry(const MapOutWireFormat_Map1Entry& from)
  ...
  if (from._internal_has_value()) {
    _impl_.value_ = new ::proto_util_converter::testing::MapM(*from._impl_.value_);
  }
...
MapOutWireFormat_Map2Entry::MapOutWireFormat_Map2Entry(const MapOutWireFormat_Map2Entry& from)
  ...
  if (from._internal_has_value()) {
    _impl_.value_ = new ::proto_util_converter::testing::MapOut(*from._impl_.value_);
  }
