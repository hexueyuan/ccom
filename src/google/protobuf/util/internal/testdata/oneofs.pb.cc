...
OneOfsRequest::OneOfsRequest(const OneOfsRequest& from)
  ...
  if (from._internal_has_any_data()) {
    _impl_.any_data_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.any_data_);
  }
  clear_has_data();
...
Data::Data(const Data& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.data_value_ = from._impl_.data_value_;
...
MoreData::MoreData(const MoreData& from)
  ...
  if (!from._internal_str_value().empty()) {
    _impl_.str_value_.Set(from._internal_str_value(), 
      GetArenaForAllocation());
  }
