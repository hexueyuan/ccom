...
NestedFieldMask::NestedFieldMask(const NestedFieldMask& from)
  ...
  if (from._internal_has_single_mask()) {
    _impl_.single_mask_ = new ::PROTOBUF_NAMESPACE_ID::FieldMask(*from._impl_.single_mask_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.NestedFieldMask)
  ...
  _impl_.repeated_mask_.MergeFrom(from._impl_.repeated_mask_);
  if (!from._internal_data().empty()) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.FieldMaskTest)
  ...
  _impl_.repeated_mask_.MergeFrom(from._impl_.repeated_mask_);
  _impl_.nested_mask_.MergeFrom(from._impl_.nested_mask_);
  if (!from._internal_id().empty()) {
...
FieldMaskTestCases::FieldMaskTestCases(const FieldMaskTestCases& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_single_mask()) {
    _impl_.single_mask_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.single_mask_);
  }
  if (from._internal_has_multiple_mask()) {
    _impl_.multiple_mask_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.multiple_mask_);
  }
  if (from._internal_has_snake_camel()) {
    _impl_.snake_camel_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.snake_camel_);
  }
  if (from._internal_has_empty_field()) {
    _impl_.empty_field_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.empty_field_);
  }
  if (from._internal_has_apiary_format1()) {
    _impl_.apiary_format1_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.apiary_format1_);
  }
  if (from._internal_has_apiary_format2()) {
    _impl_.apiary_format2_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.apiary_format2_);
  }
  if (from._internal_has_apiary_format3()) {
    _impl_.apiary_format3_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.apiary_format3_);
  }
  if (from._internal_has_map_key1()) {
    _impl_.map_key1_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.map_key1_);
  }
  if (from._internal_has_map_key2()) {
    _impl_.map_key2_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.map_key2_);
  }
  if (from._internal_has_map_key3()) {
    _impl_.map_key3_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.map_key3_);
  }
  if (from._internal_has_map_key4()) {
    _impl_.map_key4_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.map_key4_);
  }
  if (from._internal_has_map_key5()) {
    _impl_.map_key5_ = new ::proto_util_converter::testing::FieldMaskWrapper(*from._impl_.map_key5_);
  }
...
FieldMaskWrapper::FieldMaskWrapper(const FieldMaskWrapper& from)
  ...
  if (from._internal_has_mask()) {
    _impl_.mask_ = new ::PROTOBUF_NAMESPACE_ID::FieldMask(*from._impl_.mask_);
  }
