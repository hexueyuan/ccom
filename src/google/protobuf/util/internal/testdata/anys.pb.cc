...
AnyTestCases::AnyTestCases(const AnyTestCases& from)
  ...
  if (from._internal_has_empty_any()) {
    _impl_.empty_any_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.empty_any_);
  }
  if (from._internal_has_type_only_any()) {
    _impl_.type_only_any_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.type_only_any_);
  }
  if (from._internal_has_wrapper_any()) {
    _impl_.wrapper_any_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.wrapper_any_);
  }
  if (from._internal_has_any_with_timestamp_value()) {
    _impl_.any_with_timestamp_value_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_timestamp_value_);
  }
  if (from._internal_has_any_with_duration_value()) {
    _impl_.any_with_duration_value_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_duration_value_);
  }
  if (from._internal_has_any_with_struct_value()) {
    _impl_.any_with_struct_value_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_struct_value_);
  }
  if (from._internal_has_recursive_any()) {
    _impl_.recursive_any_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.recursive_any_);
  }
  if (from._internal_has_any_with_message_value()) {
    _impl_.any_with_message_value_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_value_);
  }
  if (from._internal_has_any_with_nested_message()) {
    _impl_.any_with_nested_message_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_nested_message_);
  }
  if (from._internal_has_any_with_message_with_wrapper_type()) {
    _impl_.any_with_message_with_wrapper_type_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_with_wrapper_type_);
  }
  if (from._internal_has_any_with_message_with_timestamp()) {
    _impl_.any_with_message_with_timestamp_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_with_timestamp_);
  }
  if (from._internal_has_any_with_message_containing_map()) {
    _impl_.any_with_message_containing_map_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_containing_map_);
  }
  if (from._internal_has_any_with_message_containing_struct()) {
    _impl_.any_with_message_containing_struct_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_containing_struct_);
  }
  if (from._internal_has_any_with_message_containing_repeated_message()) {
    _impl_.any_with_message_containing_repeated_message_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_message_containing_repeated_message_);
  }
  if (from._internal_has_recursive_any_with_type_field_at_end()) {
    _impl_.recursive_any_with_type_field_at_end_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.recursive_any_with_type_field_at_end_);
  }
  if (from._internal_has_repeated_any()) {
    _impl_.repeated_any_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.repeated_any_);
  }
  if (from._internal_has_empty_any_with_null_type_url()) {
    _impl_.empty_any_with_null_type_url_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.empty_any_with_null_type_url_);
  }
  if (from._internal_has_any_with_empty()) {
    _impl_.any_with_empty_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_empty_);
  }
  if (from._internal_has_any_with_default_timestamp()) {
    _impl_.any_with_default_timestamp_ = new ::proto_util_converter::testing::AnyWrapper(*from._impl_.any_with_default_timestamp_);
  }
  ...
  if (from._internal_has_top_level_any_with_type_field_at_end()) {
    _impl_.top_level_any_with_type_field_at_end_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.top_level_any_with_type_field_at_end_);
  }
  if (from._internal_has_top_level_any_with_pivot_one()) {
    _impl_.top_level_any_with_pivot_one_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.top_level_any_with_pivot_one_);
  }
  if (from._internal_has_top_level_any_with_pivot_two()) {
    _impl_.top_level_any_with_pivot_two_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.top_level_any_with_pivot_two_);
  }
  if (from._internal_has_top_level_any_unordered()) {
    _impl_.top_level_any_unordered_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.top_level_any_unordered_);
  }
...
Imports::Imports(const Imports& from)
  ...
  if (from._internal_has_dbl()) {
    _impl_.dbl_ = new ::PROTOBUF_NAMESPACE_ID::DoubleValue(*from._impl_.dbl_);
  }
  if (from._internal_has_struct_()) {
    _impl_.struct__ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.struct__);
  }
  if (from._internal_has_timestamp()) {
    _impl_.timestamp_ = new ::PROTOBUF_NAMESPACE_ID::Timestamp(*from._impl_.timestamp_);
  }
  if (from._internal_has_duration()) {
    _impl_.duration_ = new ::PROTOBUF_NAMESPACE_ID::Duration(*from._impl_.duration_);
  }
  if (from._internal_has_i32()) {
    _impl_.i32_ = new ::PROTOBUF_NAMESPACE_ID::Int32Value(*from._impl_.i32_);
  }
  if (from._internal_has_empty()) {
    _impl_.empty_ = new ::PROTOBUF_NAMESPACE_ID::Empty(*from._impl_.empty_);
  }
  if (from._internal_has_data()) {
    _impl_.data_ = new ::proto_util_converter::testing::Data(*from._impl_.data_);
  }
...
Data::Data(const Data& from)
  ...
  if (from._internal_has_nested_data()) {
    _impl_.nested_data_ = new ::proto_util_converter::testing::Data(*from._impl_.nested_data_);
  }
  if (from._internal_has_int_wrapper()) {
    _impl_.int_wrapper_ = new ::PROTOBUF_NAMESPACE_ID::Int32Value(*from._impl_.int_wrapper_);
  }
  if (from._internal_has_time()) {
    _impl_.time_ = new ::PROTOBUF_NAMESPACE_ID::Timestamp(*from._impl_.time_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.Data)
  ...
  _impl_.repeated_any_.MergeFrom(from._impl_.repeated_any_);
  if (!from._internal_str().empty()) {
...
AnyIn::AnyIn(const AnyIn& from)
  ...
  if (!from._internal_something().empty()) {
    _impl_.something_.Set(from._internal_something(), 
      GetArenaForAllocation());
  }
  if (from._internal_has_any()) {
    _impl_.any_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.any_);
...
AnyM::AnyM(const AnyM& from)
  ...
  if (!from._internal_foo().empty()) {
    _impl_.foo_.Set(from._internal_foo(), 
      GetArenaForAllocation());
  }
