...
DefaultValueTestCases::DefaultValueTestCases(const DefaultValueTestCases& from)
  ...
  if (from._internal_has_empty_double()) {
    _impl_.empty_double_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.empty_double_);
  }
  if (from._internal_has_double_with_default_value()) {
    _impl_.double_with_default_value_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.double_with_default_value_);
  }
  if (from._internal_has_double_with_nondefault_value()) {
    _impl_.double_with_nondefault_value_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.double_with_nondefault_value_);
  }
  if (from._internal_has_repeated_double()) {
    _impl_.repeated_double_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.repeated_double_);
  }
  if (from._internal_has_nested_message()) {
    _impl_.nested_message_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.nested_message_);
  }
  if (from._internal_has_repeated_nested_message()) {
    _impl_.repeated_nested_message_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.repeated_nested_message_);
  }
  if (from._internal_has_double_message_with_oneof()) {
    _impl_.double_message_with_oneof_ = new ::proto_util_converter::testing::DoubleMessage(*from._impl_.double_message_with_oneof_);
  }
  if (from._internal_has_empty_struct()) {
    _impl_.empty_struct_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.empty_struct_);
  }
  if (from._internal_has_empty_struct2()) {
    _impl_.empty_struct2_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.empty_struct2_);
  }
  if (from._internal_has_struct_with_null_value()) {
    _impl_.struct_with_null_value_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_null_value_);
  }
  if (from._internal_has_struct_with_values()) {
    _impl_.struct_with_values_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_values_);
  }
  if (from._internal_has_struct_with_nested_struct()) {
    _impl_.struct_with_nested_struct_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_nested_struct_);
  }
  if (from._internal_has_struct_with_nested_list()) {
    _impl_.struct_with_nested_list_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_nested_list_);
  }
  if (from._internal_has_struct_with_list_of_nulls()) {
    _impl_.struct_with_list_of_nulls_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_list_of_nulls_);
  }
  if (from._internal_has_struct_with_list_of_lists()) {
    _impl_.struct_with_list_of_lists_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_list_of_lists_);
  }
  if (from._internal_has_struct_with_list_of_structs()) {
    _impl_.struct_with_list_of_structs_ = new ::proto_util_converter::testing::StructMessage(*from._impl_.struct_with_list_of_structs_);
  }
  if (from._internal_has_top_level_struct()) {
    _impl_.top_level_struct_ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.top_level_struct_);
  }
  if (from._internal_has_value_wrapper_simple()) {
    _impl_.value_wrapper_simple_ = new ::proto_util_converter::testing::ValueMessage(*from._impl_.value_wrapper_simple_);
  }
  if (from._internal_has_value_wrapper_with_struct()) {
    _impl_.value_wrapper_with_struct_ = new ::proto_util_converter::testing::ValueMessage(*from._impl_.value_wrapper_with_struct_);
  }
  if (from._internal_has_value_wrapper_with_list()) {
    _impl_.value_wrapper_with_list_ = new ::proto_util_converter::testing::ValueMessage(*from._impl_.value_wrapper_with_list_);
  }
  if (from._internal_has_list_value_wrapper()) {
    _impl_.list_value_wrapper_ = new ::proto_util_converter::testing::ListValueMessage(*from._impl_.list_value_wrapper_);
  }
  if (from._internal_has_top_level_value_simple()) {
    _impl_.top_level_value_simple_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.top_level_value_simple_);
  }
  if (from._internal_has_top_level_value_with_struct()) {
    _impl_.top_level_value_with_struct_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.top_level_value_with_struct_);
  }
  if (from._internal_has_top_level_value_with_list()) {
    _impl_.top_level_value_with_list_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.top_level_value_with_list_);
  }
  if (from._internal_has_top_level_listvalue()) {
    _impl_.top_level_listvalue_ = new ::PROTOBUF_NAMESPACE_ID::ListValue(*from._impl_.top_level_listvalue_);
  }
  if (from._internal_has_empty_any()) {
    _impl_.empty_any_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.empty_any_);
  }
  if (from._internal_has_type_only_any()) {
    _impl_.type_only_any_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.type_only_any_);
  }
  if (from._internal_has_recursive_any()) {
    _impl_.recursive_any_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.recursive_any_);
  }
  if (from._internal_has_any_with_message_value()) {
    _impl_.any_with_message_value_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.any_with_message_value_);
  }
  if (from._internal_has_any_with_nested_message()) {
    _impl_.any_with_nested_message_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.any_with_nested_message_);
  }
  if (from._internal_has_any_with_message_containing_map()) {
    _impl_.any_with_message_containing_map_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.any_with_message_containing_map_);
  }
  if (from._internal_has_any_with_message_containing_struct()) {
    _impl_.any_with_message_containing_struct_ = new ::proto_util_converter::testing::AnyMessage(*from._impl_.any_with_message_containing_struct_);
  }
  if (from._internal_has_top_level_any()) {
    _impl_.top_level_any_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.top_level_any_);
  }
  if (from._internal_has_empty_map()) {
    _impl_.empty_map_ = new ::proto_util_converter::testing::StringtoIntMap(*from._impl_.empty_map_);
  }
  if (from._internal_has_string_to_int()) {
    _impl_.string_to_int_ = new ::proto_util_converter::testing::StringtoIntMap(*from._impl_.string_to_int_);
  }
  if (from._internal_has_int_to_string()) {
    _impl_.int_to_string_ = new ::proto_util_converter::testing::IntToStringMap(*from._impl_.int_to_string_);
  }
  if (from._internal_has_mixed1()) {
    _impl_.mixed1_ = new ::proto_util_converter::testing::MixedMap(*from._impl_.mixed1_);
  }
  if (from._internal_has_mixed2()) {
    _impl_.mixed2_ = new ::proto_util_converter::testing::MixedMap2(*from._impl_.mixed2_);
  }
  if (from._internal_has_empty_mixed2()) {
    _impl_.empty_mixed2_ = new ::proto_util_converter::testing::MixedMap2(*from._impl_.empty_mixed2_);
  }
  if (from._internal_has_map_of_objects()) {
    _impl_.map_of_objects_ = new ::proto_util_converter::testing::MessageMap(*from._impl_.map_of_objects_);
  }
  if (from._internal_has_mixed_empty()) {
    _impl_.mixed_empty_ = new ::proto_util_converter::testing::MixedMap(*from._impl_.mixed_empty_);
  }
  if (from._internal_has_message_map_empty()) {
    _impl_.message_map_empty_ = new ::proto_util_converter::testing::MessageMap(*from._impl_.message_map_empty_);
  }
  if (from._internal_has_double_value()) {
    _impl_.double_value_ = new ::proto_util_converter::testing::DoubleValueMessage(*from._impl_.double_value_);
  }
  if (from._internal_has_double_value_default()) {
    _impl_.double_value_default_ = new ::proto_util_converter::testing::DoubleValueMessage(*from._impl_.double_value_default_);
  }
...
DoubleMessage::DoubleMessage(const DoubleMessage& from)
  ...
  if (from._internal_has_double_wrapper()) {
    _impl_.double_wrapper_ = new ::PROTOBUF_NAMESPACE_ID::DoubleValue(*from._impl_.double_wrapper_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.DoubleMessage)
  ...
  _impl_.repeated_double_.MergeFrom(from._impl_.repeated_double_);
  _impl_.repeated_nested_message_.MergeFrom(from._impl_.repeated_nested_message_);
  if (from._internal_has_nested_message()) {
    _internal_mutable_nested_message()->::proto_util_converter::testing::DoubleMessage::MergeFrom(from._internal_nested_message());
  }
  if (from._internal_has_double_wrapper()) {
...
StructMessage::StructMessage(const StructMessage& from)
  ...
  if (from._internal_has_struct_()) {
    _impl_.struct__ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.struct__);
  }
...
ValueMessage::ValueMessage(const ValueMessage& from)
  ...
  if (from._internal_has_value()) {
    _impl_.value_ = new ::PROTOBUF_NAMESPACE_ID::Value(*from._impl_.value_);
  }
...
ListValueMessage::ListValueMessage(const ListValueMessage& from)
  ...
  if (from._internal_has_shopping_list()) {
    _impl_.shopping_list_ = new ::PROTOBUF_NAMESPACE_ID::ListValue(*from._impl_.shopping_list_);
  }
...
AnyMessage::AnyMessage(const AnyMessage& from)
  ...
  if (from._internal_has_any()) {
    _impl_.any_ = new ::PROTOBUF_NAMESPACE_ID::Any(*from._impl_.any_);
  }
  if (from._internal_has_data()) {
    _impl_.data_ = new ::proto_util_converter::testing::AnyData(*from._impl_.data_);
  }
...
AnyData::AnyData(const AnyData& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.map_data_.MergeFrom(from._impl_.map_data_);
  _impl_.str_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.str_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_str().empty()) {
    _impl_.str_.Set(from._internal_str(), 
      GetArenaForAllocation());
  }
  if (from._internal_has_nested_data()) {
    _impl_.nested_data_ = new ::proto_util_converter::testing::AnyData(*from._impl_.nested_data_);
  }
  if (from._internal_has_struct_data()) {
    _impl_.struct_data_ = new ::PROTOBUF_NAMESPACE_ID::Struct(*from._impl_.struct_data_);
  }
  _impl_.attr_ = from._impl_.attr_;
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.AnyData)
  ...
  _impl_.msgs_.MergeFrom(from._impl_.msgs_);
  _impl_.map_data_.MergeFrom(from._impl_.map_data_);
  _impl_.repeated_data_.MergeFrom(from._impl_.repeated_data_);
  if (!from._internal_str().empty()) {
...
StringtoIntMap::StringtoIntMap(const StringtoIntMap& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.map_.MergeFrom(from._impl_.map_);
...
MixedMap::MixedMap(const MixedMap& from)
  ...
  _impl_.int_value_ = from._impl_.int_value_;
...
MessageMap_M::MessageMap_M(const MessageMap_M& from)
  ...
  if (!from._internal_inner_text().empty()) {
    _impl_.inner_text_.Set(from._internal_inner_text(), 
      GetArenaForAllocation());
  }
  _impl_.inner_int_ = from._impl_.inner_int_;
...
DoubleValueMessage::DoubleValueMessage(const DoubleValueMessage& from)
  ...
  if (from._internal_has_double_()) {
    _impl_.double__ = new ::PROTOBUF_NAMESPACE_ID::DoubleValue(*from._impl_.double__);
  }
