...
TestConflictingSymbolNames::TestConflictingSymbolNames(const TestConflictingSymbolNames& from)
  ...
  if (from._internal_has_length()) {
    _impl_.length_.Set(from._internal_length(), 
  ...
  if (from._internal_has_string()) {
    _impl_.string_.Set(from._internal_string(), 
      GetArenaForAllocation());
  }
  ...
  if (from._internal_has_some_cord()) {
    _impl_.some_cord_.Set(from._internal_some_cord(), 
      GetArenaForAllocation());
  }
  ...
  if (from._internal_has_some_string_piece()) {
    _impl_.some_string_piece_.Set(from._internal_some_string_piece(), 
      GetArenaForAllocation());
  }
  ...
  if (from._internal_has_release_length()) {
    _impl_.release_length_.Set(from._internal_release_length(), 
      GetArenaForAllocation());
  }
  ...
  if (from._internal_has_target()) {
    _impl_.target_.Set(from._internal_target(), 
      GetArenaForAllocation());
  }
  if (from._internal_has_do_()) {
    _impl_.do__ = new ::protobuf_unittest::TestConflictingSymbolNames_DO(*from._impl_.do__);
  }
  if (from._internal_has_release_do()) {
    _impl_.release_do_ = new ::protobuf_unittest::TestConflictingSymbolNames_DO(*from._impl_.release_do_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf_unittest.TestConflictingSymbolNames)
  ...
  _impl_.i_.MergeFrom(from._impl_.i_);
  _impl_.new_element_.MergeFrom(from._impl_.new_element_);
  _impl_.index_.MergeFrom(from._impl_.index_);
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00004000u) {
      _impl_.file_ = from._impl_.file_;
    }
    if (cached_has_bits & 0x00008000u) {
  ...
  if (cached_has_bits & 0x00ff0000u) {
    if (cached_has_bits & 0x00010000u) {
      _impl_.handle_uninterpreted_ = from._impl_.handle_uninterpreted_;
    }
    if (cached_has_bits & 0x00020000u) {
      _impl_.controller_ = from._impl_.controller_;
    }
    if (cached_has_bits & 0x00040000u) {
      _impl_.already_here_ = from._impl_.already_here_;
    }
    if (cached_has_bits & 0x00080000u) {
      _impl_.uint32_ = from._impl_.uint32_;
    }
    if (cached_has_bits & 0x00100000u) {
      _impl_.uint64_ = from._impl_.uint64_;
    }
    if (cached_has_bits & 0x00200000u) {
      _impl_.memset_ = from._impl_.memset_;
    }
    if (cached_has_bits & 0x00400000u) {
      _impl_.int32_ = from._impl_.int32_;
    }
    if (cached_has_bits & 0x00800000u) {
      _impl_.int64_ = from._impl_.int64_;
    }
    _impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0xff000000u) {
    if (cached_has_bits & 0x01000000u) {
      _impl_.cached_size_ = from._impl_.cached_size_;
    }
    if (cached_has_bits & 0x02000000u) {
      _impl_.extensions_ = from._impl_.extensions_;
    }
    if (cached_has_bits & 0x04000000u) {
      _impl_.bit_ = from._impl_.bit_;
    }
    if (cached_has_bits & 0x08000000u) {
      _impl_.bits_ = from._impl_.bits_;
    }
    if (cached_has_bits & 0x10000000u) {
      _impl_.offsets_ = from._impl_.offsets_;
    }
    if (cached_has_bits & 0x20000000u) {
      _impl_.reflection_ = from._impl_.reflection_;
    }
    if (cached_has_bits & 0x40000000u) {
      _impl_.int__ = from._impl_.int__;
    }
    if (cached_has_bits & 0x80000000u) {
      _impl_.friend__ = from._impl_.friend__;
    }
    _impl_._has_bits_[0] |= cached_has_bits;
  }
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _impl_.is_packed_ = from._impl_.is_packed_;
    }
    if (cached_has_bits & 0x00000004u) {
      _impl_.class__ = from._impl_.class__;
    }
    if (cached_has_bits & 0x00000008u) {
      _impl_.typedecl_ = from._impl_.typedecl_;
    }
    if (cached_has_bits & 0x00000010u) {
      _impl_.auto__ = from._impl_.auto__;
    }
...
TestConflictingEnumNames::TestConflictingEnumNames(const TestConflictingEnumNames& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.conflicting_enum_ = from._impl_.conflicting_enum_;
